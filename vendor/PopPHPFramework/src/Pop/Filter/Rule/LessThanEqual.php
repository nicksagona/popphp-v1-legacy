...
class LessThanEqual extends AbstractRule
{
    ...
    public function evaluate($input = null)
    {
        ...
        if ($this->_condition) {
            $this->_defaultMessage = Locale::factory()->__('The value must be less than or equal to %1.', $this->_value);
        } else {
            $this->_defaultMessage = Locale::factory()->__('The value must not be less than or equal to %1.', $this->_value);
        }
