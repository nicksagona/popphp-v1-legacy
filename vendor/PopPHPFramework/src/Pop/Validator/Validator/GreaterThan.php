...
class GreaterThan extends AbstractValidator
{
    ...
    public function evaluate($input = null)
    {
        ...
        if ($this->_condition) {
            $this->_defaultMessage = Locale::factory()->__('The value must be greater than %1.', $this->_value);
        } else {
            $this->_defaultMessage = Locale::factory()->__('The value must not be greater than %1.', $this->_value);
        }
