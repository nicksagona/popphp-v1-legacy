...
العنصر هو عنصر نموذج القوية التي تمتد المكون دوم. فإنه يوفر وظائف قوية
لخلق، أو أن تصبح والتحقق من صحة HTML أشكال وعناصر النموذج.
...
أو، يمكنك إنشاء عناصر النموذج عن طريق مجموعة منظمة من القيم.
...
مع الطبقة الحقول، يمكنك استخدام جدول قاعدة بيانات من خلال عنصر للوصول
إلى سجل وبناء الحقول الأولية من النموذج.
