...
Paginator компонент просто предоставляет функциональные возможности для
страницы из большого набора результатов. Много различных параметров и
атрибутов может быть применен, но наиболее полезным является поддержка
шаблонов, что он встроенного
