...
Фильтр компонент предоставляет некоторые полезные функции фильтрации для работы со строками, шифрование, поиск массива и некоторые основные математике.
