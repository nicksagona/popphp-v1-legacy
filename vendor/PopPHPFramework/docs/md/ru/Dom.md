...
Дом компонент предоставляет простой способ для создания и манипулирования DOM документов и их детей.
...
Вы также можете добавить детей с помощью структурированного массива значений.
