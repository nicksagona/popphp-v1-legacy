...
Или, вы можете создать элементы формы с помощью структурированного массива значений.
...
С полей класса, вы можете использовать таблицы базы данных с помощью компонента записи для доступа и создания начального поля формы.
