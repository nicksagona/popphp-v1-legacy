...
Η συνιστώσα Paginator παρέχει απλά τη λειτουργικότητα στη σελίδα από ένα
μεγάλο σύνολο αποτελεσμάτων. Πολλές διαφορετικές ρυθμίσεις και τα
χαρακτηριστικά μπορούν να εφαρμοστούν, αλλά η πλέον χρήσιμη είναι η
υποστήριξη που το πρότυπο χτισμένο in
