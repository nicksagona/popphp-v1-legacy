...
Το Nav στοιχείο παρέχει τη λειτουργικότητα για να διαμορφώσετε, να
χτίσουν και να εξάγει ένα HTML με βάση το δέντρο πλοήγησης. Μπορεί
επίσης να χρησιμοποιούν προαιρετικά το στοιχείο Acl για ποιοτικό
έλεγχο πρόσβασης στο δέντρο περιήγησης.
