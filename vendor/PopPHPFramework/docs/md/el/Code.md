...
Το συστατικό Κώδικας είναι ένα συστατικό παραγωγή κώδικα που όχι μόνο
σας επιτρέπει να δημιουργήσετε τυποποιημένες, άρτια δομημένο κώδικα PHP
on the fly, αλλά σας επιτρέπει επίσης να τροποποιήσει και να επεκτείνει
υπάρχοντα κώδικα με τη μόχλευση επέκταση Αντανάκλαση της PHP.
