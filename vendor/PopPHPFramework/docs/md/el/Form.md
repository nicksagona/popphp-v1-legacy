...
Το συστατικό έντυπο είναι ένα ισχυρό συστατικό που επεκτείνει το
στοιχείο Dom. Παρέχει ισχυρή λειτουργικότητα για τη δημιουργία, την
απόδοση και την επικύρωση HTML φόρμες και στοιχεία φόρμας.
...
Ή, μπορείτε να δημιουργήσετε στοιχεία μορφή μέσω μιας δομημένης πίνακα
τιμών.
...
Με την κατηγορία πεδία, μπορείτε να χρησιμοποιήσετε έναν πίνακα βάσης
δεδομένων μέσω του στοιχείου εγγραφής για να έχουν πρόσβαση και να
οικοδομήσουμε τις αρχικές πεδία της φόρμας.
