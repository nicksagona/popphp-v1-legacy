...
Η συνιστώσα της φόρμας είναι ένα ισχυρό στοιχείο που επεκτείνει το στοιχείο Dom. Παρέχει ισχυρή δυνατότητα να δημιουργήσετε, να καταστήσει και έγκυρη HTML φόρμες και στοιχεία της φόρμας.
...
Ή, μπορείτε να δημιουργήσετε στοιχεία της φόρμας μέσω ενός δομημένου πίνακα τιμών.
...
Με την κατηγορία πεδία, μπορείτε να χρησιμοποιήσετε έναν πίνακα βάσης δεδομένων μέσω του στοιχείου εγγραφής για να έχουν πρόσβαση και να οικοδομήσουμε τις αρχικές πεδία της φόρμας.
