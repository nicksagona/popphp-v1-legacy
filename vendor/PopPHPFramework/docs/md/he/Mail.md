...
הרכיב האלקטרוני מספק את הפונקציונליות הדרושה כדי לנהל את הדואר יוצא
באמצעות PHP. זה כולל תמיכה בדוא"ל מבוסס טקסט ומבוסס HTML, נמעני דואר
מרובים, תבניות וקבצים מצורפים.
