...
מרכיב Paginator פשוט מספק את הפונקציונליות לדף את ערכת תוצאות גדולה.
ניתן ליישם הגדרות רבות ושונות ותכונות, אבל השימושי ביותר היא תמיכת
התבנית שממנה בנויות פנימה
