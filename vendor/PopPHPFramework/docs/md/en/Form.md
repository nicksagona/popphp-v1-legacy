...
The Form component is a powerful component that extends the Dom
component. It provides robust functionality to create, render and
validate HTML forms and form elements.
...
With the Fields class, you can use a database table via the Record
component to access and build the initial fields of the form.
