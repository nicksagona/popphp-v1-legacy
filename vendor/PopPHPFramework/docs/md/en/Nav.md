...
The Nav component provides the functionality to configure, build and
output an HTML-based navigation tree. It can also optionally utilize
the Acl component for fine-grain access control within the navigation
tree.
