...
The Paginator component simply provides the functionality to page out a
large result set. Many different settings and attributes can be applied,
but the most useful is the template support that it built in.
