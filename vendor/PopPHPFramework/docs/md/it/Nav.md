...
Il componente Nav fornisce la funzionalità per configurare, costruire
e produrre un albero di navigazione basato su HTML. Si può anche
opzionalmente utilizzare il componente ACL per il controllo di accesso
a grana fine all'interno della struttura di navigazione.
