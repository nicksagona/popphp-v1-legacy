...
O componente de cor ̩ um componente ̼til para gerenciar e utilizar
objetos de valor de cor. Ele tamb̩m oferece a funcionalidade de
converter valores de cores para outros espa̤os de cor, por exemplo, a
converṣo de RGB para CMYK.
