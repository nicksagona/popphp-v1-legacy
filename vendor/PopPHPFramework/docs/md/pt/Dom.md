...
O componente de Dom fornece uma maneira fácil de criar e manipular documentos DOM e seus filhos.
...
Você também pode adicionar as crianças através de um conjunto estruturado de valores.
