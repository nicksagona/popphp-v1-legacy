...
O componente de navegação fornece a funcionalidade para configurar,
construir e produzir uma árvore de navegação baseado em HTML. Ele
também pode, opcionalmente, utilizar o componente ACL para controle
de acesso de grão fino da árvore de navegação.
