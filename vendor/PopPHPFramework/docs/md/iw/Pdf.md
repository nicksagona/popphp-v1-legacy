...
מרכיב Pdf מספק עשיר בתכונות פונקציונליות עבור הדור מניפולציה PDF ו. יחד ליצירת קבצי PDF חדשים, אתה יכול גם לייבא הקיימים ולהוסיף תוכן אותם משם. חלק מהתכונות הזמינות הן:
