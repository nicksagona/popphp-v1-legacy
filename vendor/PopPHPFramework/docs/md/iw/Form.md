...
או, אתה יכול ליצור אלמנטים טופס באמצעות מערך מובנה של ערכים.
...
עם כיתת השדות, אתה יכול להשתמש בטבלת מסד נתונים דרך רכיב השיא לגשת ולבנות את השדות הראשוניים של הטופס.
