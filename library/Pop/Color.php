...
class Pop_Color
{
    ...
    public function rgbToCmyk(Pop_Color_Rgb $rgb)
    {
        ...
        return new Pop_Color_Cmyk($cyan, $magenta, $yellow, $black);
    }
    ...
    public function rgbToHsb(Pop_Color_Rgb $rgb)
    {
        ...
        return new Pop_Color_Hsb(round($h * 360), round($s * 100), round($b * 100));
    }
    ...
    public function rgbToLab(Pop_Color_Rgb $rgb)
    {
        ...
        return new Pop_Color_Lab($l, $a, $b);
    }
    ...
    public function cmykToRgb(Pop_Color_Cmyk $cmyk)
    {
        ...
        return new Pop_Color_Rgb($r, $g, $b);
    }
